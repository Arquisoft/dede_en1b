...
The deployment url is: [https://arquisoft.github.io/dede_en1b/](https://arquisoft.github.io/dede_en1b/).
...
If we want to deploy it to GitHub pages, so it is accesible via [https://arquisoft.github.io/dede_en1b/](https://arquisoft.github.io/dede_en1b/) we need to execute `npm run deploy`.
